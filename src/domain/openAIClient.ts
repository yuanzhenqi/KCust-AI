  ...
  return [
    {
      ...
      content: [
        ...
        '首次记录新客户时返回 create-customer，payload 可包含 name、wechatName、city、budgetWan、areaSqm、propertyType、household、stage、sourceChannel、stylePreference、needs、notes、demandDate、urgent、serviceValue、firstInteractionAt、firstInteractionSummary、nextAction。',
        ...
        '如果用户要追加或修改客户资料，例如“张总需要加整体浴室”“预算调整为60万”“家里有4口人”“养了一只猫”，返回 update-customer，payload 为 { "customerId": string|null, "customerName": string, "city": string, "need"?: string, "needs"?: string[], "budgetWan"?: number, "areaSqm"?: number, "propertyType"?: string, "household"?: string, "stage"?: string, "sourceChannel"?: string, "stylePreference"?: string, "notes"?: string }。',
